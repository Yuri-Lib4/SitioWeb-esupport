        ...
        <div>
            ...
            <Link to="/ruta-para-software" className="back-link">
                ...
                <div className="impresora-software-container">
                    <div>
                        <h3 className="text-software-h3">Software y Controladores: identifique su portátil</h3>
                    </div>
                    <div></div>
                    <div className="impresora-software-iconos-container">
                        ...
                        <Link to="/portatil">
                            <LiaLaptopSolid className="impresora-software-icon icon-laptoportatil" />
                        </Link>
                        <Link to="/sobremesa">
